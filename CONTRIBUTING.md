Contributing to Arktur Core
============================

The Arktur Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Arktur Core project, and is not to be
confused with overall Arktur Network Protocol consensus changes.

Whether a pull request is merged into Arktur Core rests with the project merge
...
Patches that change Arktur consensus rules are considerably more involved than
...
Where a patch set proposes to change the Arktur consensus, it must have been
...
The project leader is the release manager for each Arktur Core release.

...
In order to support loading of multiple wallets in arktur-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is arktur.cpp.
...
Changes to arktur.cpp
----------------------
arktur.cpp is the entry point into arktur-qt, and as such, will require some minor modifications to provide hooks for

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Arktur features */
        {"arktur", "masternode", &masternode, true, true, false},
        {"arktur", "listmasternodes", &listmasternodes, true, true, false},
        {"arktur", "getmasternodecount", &getmasternodecount, true, true, false},
        {"arktur", "masternodeconnect", &masternodeconnect, true, true, false},
        {"arktur", "masternodecurrent", &masternodecurrent, true, true, false},
        {"arktur", "masternodedebug", &masternodedebug, true, true, false},
        {"arktur", "startmasternode", &startmasternode, true, true, false},
        {"arktur", "createmasternodekey", &createmasternodekey, true, true, false},
        {"arktur", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"arktur", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"arktur", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"arktur", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"arktur", "getmasternodescores", &getmasternodescores, true, true, false},
        {"arktur", "mnbudget", &mnbudget, true, true, false},
        {"arktur", "preparebudget", &preparebudget, true, true, false},
        {"arktur", "submitbudget", &submitbudget, true, true, false},
        {"arktur", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"arktur", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"arktur", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"arktur", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"arktur", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"arktur", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"arktur", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"arktur", "checkbudgets", &checkbudgets, true, true, false},
        {"arktur", "mnsync", &mnsync, true, true, false},
        {"arktur", "spork", &spork, true, true, false},
        {"arktur", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"arktur", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use arkturd, or the -server option to arktur-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> arktur-cli " + methodname + " " + args + "\n";
}

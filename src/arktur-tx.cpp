...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Arktur Core arktur-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  arktur-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded arktur transaction") + "\n" +
                               "  arktur-tx [options] -create [commands]   " + _("Create hex-encoded arktur transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arktur transaction

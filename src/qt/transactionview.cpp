                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Arktur from zArktur"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zArktur"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zArktur));

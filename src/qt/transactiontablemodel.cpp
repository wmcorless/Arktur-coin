...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Arktur to zArktur");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zArktur");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Arktur from zArktur");
    case TransactionRecord::ZerocoinSpend_Change_zArktur:
        return tr("Minted Change as zArktur from zArktur Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zArktur to Arktur");

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Arktur Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Arktur address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and arktur: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zARKT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Arktur Core"), this);
    aboutAction->setStatusTip(tr("Show information about Arktur Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Arktur"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Arktur addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Arktur addresses"));
    ...
    openAction->setStatusTip(tr("Open a Arktur: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Arktur Core help message to get a list with possible Arktur command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Arktur Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Arktur network", "", count));
}
...
{
    QString strTitle = tr("Arktur Core"); // default title

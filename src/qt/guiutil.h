...
/** Utility functions used by the Arktur Qt UI.
 */
namespace GUIUtil
{
...
// Render Arktur addresses in monospace font
...
// Parse "arktur:" URI into recipient object, return true on successful parsing

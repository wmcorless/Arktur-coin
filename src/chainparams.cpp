...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 40001;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Arktur starting difficulty is 1 / 2^12
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Arctur-1, a supercomputer in Slovenia has announced that they will accept Bitcoin.";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.arkturcoin.net"));
        vSeeds.push_back(CDNSSeedData("seed2", "seed2.arkturcoin.net"));
        vSeeds.push_back(CDNSSeedData("seed3", "seed3.arkturcoin.net"));
        ...
        strSporkKey = "04afc8d45a997170ba085f9e03803b21f040157c90e0388f44c100959c4017142a31d1b5e4a271881bdcf86929768318af3cb4ecb1dae9c7774634154a229ab0b0";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Arktur: 1 day
        nTargetSpacing = 1 * 60;  // Arktur: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        genesis.nTime = 1528564189;  // Sat, 09 Jun 2018 17:09:49 GMT
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 0x164ff;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.arktur.io", "testnet.arktur.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.arktur.io", "testnet1.arktur.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet2.arktur.io", "testnet2.arktur.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Arktur: 1 day
        nTargetSpacing = 1 * 60;        // Arktur: 1 minutes

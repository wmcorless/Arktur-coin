...
RESOURCES += src/qt/arktur.qrc src/qt/arktur_locale.qrc

TRANSLATIONS += src/qt/locale/arktur_bg.ts \
                src/qt/locale/arktur_de.ts \
                src/qt/locale/arktur_en.ts \
                src/qt/locale/arktur_es.ts \
                src/qt/locale/arktur_fi.ts \
                src/qt/locale/arktur_fr.ts \
                src/qt/locale/arktur_it.ts \
                src/qt/locale/arktur_ja.ts \
                src/qt/locale/arktur_pl.ts \
                src/qt/locale/arktur_pt.ts \
                src/qt/locale/arktur_ru.ts \
                src/qt/locale/arktur_sk.ts \
                src/qt/locale/arktur_sv.ts \
                src/qt/locale/arktur_vi.ts \
                src/qt/locale/arktur_zh_CN.ts \
                src/qt/locale/arktur_zh_TW.ts
